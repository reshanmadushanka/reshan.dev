...
export const BentoGridItem = ({
  ...
  const leftLists = ["Laravel", "PHP", "Javascript"];
  ...
  const handleCopy = () => {
    const text = "reshanmadushanka@gmail.com";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {id === 3 && (
          <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 md:-right-3 lg:-right-1 top-0">
            {/* tech stack lists */}
            <div className="flex flex-col gap-3 md:gap-3 lg:gap-6">
              {leftLists.map((item, i) => (
                <span
                  key={i}
                  className="lg:py-1 lg:px-3 py-2 px-3 text-xs lg:text-sm opacity-50 
