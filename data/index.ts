...
export const projects = [
  {
    id: 1,
    title: "PalmMistVilla & Transport",
    des: "A comprehensive website for PalmMistVilla, showcasing luxury villas and transport services with a modern, responsive design.",
    img: "/palmmist.png",
    iconLists: ["/re.svg", "/tail.svg", "/ts.svg"],
    link: "https://palmmistvilla.com/",
  },
  {
    id: 2,
...
export const skillSections = [
  {
    ...
    description: "Application logic, APIs, security, and scalable backend delivery.",
    items: [
      "PHP 8+",
      "Laravel",
      "CodeIgniter",
  ...
  },
  {
    ...
    description: "Modern interfaces that are responsive, fast, and maintainable.",
    items: [
      "Vue.js",
      "Vue 3",
      "TypeScript",
  ...
  },
  {
    ...
    description: "Database design, reporting, and application performance tuning.",
    items: [
      "MySQL",
      "PostgreSQL",
      "SQL",
  ...
  {
    title: "DevOps & Cloud",
    description: "Build, deploy, and maintain applications across modern platforms.",
    items: [
      "Docker",
      "AWS",
      "Oracle Cloud",
  ...
  },
  {
    ...
    description: "Third-party platforms and AI-assisted development workflows.",
    items: [
      "Stripe API",
      "Google Maps API",
      "Zoom API",
  ...
  },
  {
    ...
    description: "The habits that keep teams shipping clean, reliable software.",
    items: [
      "Agile",
      "TDD",
  ...
  {
    title: "Soft Skills",
    description: "How I work with people, not just code.",
    items: [
      "Leadership",
      "Mentorship",
      "Problem-Solving",
